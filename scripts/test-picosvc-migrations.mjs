...
const migrations = readdirSync(new URL('../migrations/', import.meta.url))
  ...
  .sort();
assert.ok(migrations.length >= 13, 'Expected PicoSvc additive migrations 0010–0022');
...
for (const table of [
  ...
  'mail_events', 'mail_attachments', 'cron_runs', 'file_objects', 'json_documents', 'json_store_tokens',
