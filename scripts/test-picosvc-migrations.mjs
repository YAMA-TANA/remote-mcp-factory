...
for (const table of ['rss_feeds', 'rss_entries', 'webhook_events', 'webhook_deliveries', 'mock_endpoints', 'mock_rules', 'mock_requests', 'qr_links', 'qr_scan_daily', 'flag_projects', 'feature_flags', 'mcp_sandbox_active_minutes', 'mail_events', 'cron_runs', 'file_objects', 'json_documents']) {
