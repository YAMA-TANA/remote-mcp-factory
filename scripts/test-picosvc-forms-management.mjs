...
assert.match(wrapper, /function FormsWorkspace[\s\S]*<FormsManagementDetail/, 'Forms workspace must retain its dedicated console');
assert.match(wrapper, /props\.service === 'forms'.*<FormsWorkspace/, 'Forms resources must route through their composed workspace');
