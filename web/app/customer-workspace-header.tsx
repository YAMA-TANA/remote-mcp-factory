...
const COPY = {
  ja: { overview: 'サービス説明', docs: '使い方・API例', all: '全体ダッシュボード', usage: '利用量・上限' },
  en: { overview: 'Product overview', docs: 'How-to & API examples', all: 'All-service dashboard', usage: 'Usage & limits' },
  'zh-CN': { overview: '服务介绍', docs: '使用指南与 API 示例', all: '全部服务总览', usage: '用量与限额' },
} as const;
