  ...
  return <header className="customerWorkspaceShell">
    <nav className="customerNav shell" aria-label="PicoSvc">
      ...
      <div className="customerNavLinks">
        ...
        {(service === 'mcp' || service === 'cron' || service === 'mail' || service === 'qr' || service === 'rss' || service === 'functions' || service === 'monitor' || service === 'forms' || service === 'license') && <a href={`/${lang}/${service}/manage/`}>{c.fleet}</a>}
