...
const EN: Messages = {
  ...
  products: {
    mcp: { role: 'MCP hosting / Remote conversion', pricing: 'Paid from $1/mo' }, mock: { role: 'Mock API', pricing: 'Paid from $1/mo' }, hooks: { role: 'Webhook inbox / replay', pricing: 'Paid from $1/mo' }, rss: { role: 'Web → RSS', pricing: 'Paid from $1/mo' }, mail: { role: 'Email → Webhook', pricing: 'Paid from $1/mo' }, shot: { role: 'Screenshot / PDF', pricing: 'Paid from $1/mo' }, fetch: { role: 'URL → Markdown / metadata', pricing: 'Paid from $1/mo' }, qr: { role: 'Dynamic QR / redirect', pricing: 'Paid from $1/mo' }, cron: { role: 'Cron execution / monitoring', pricing: 'Paid from $1/mo' }, functions: { role: 'Tiny serverless functions', pricing: 'Paid from $1/mo' }, json: { role: 'JSON API / tiny database', pricing: 'Paid from $1/mo' }, files: { role: 'R2-backed file delivery', pricing: 'Paid from $1/mo' }, license: { role: 'License key validation', pricing: 'Paid from $1/mo' }, flags: { role: 'Remote Config', pricing: 'Paid from $1/mo' }, monitor: { role: 'Web page change monitoring', pricing: 'Paid from $1/mo' }, forms: { role: 'Form backend', pricing: 'Paid from $1/mo' }
  }
};
...
const JA: Messages = {
  ...
  products: {
    mcp: { role: 'MCPホスティング / Remote変換', pricing: '有料 $1/月〜' }, mock: { role: 'Mock API', pricing: '有料 $1/月〜' }, hooks: { role: 'Webhook inbox / replay', pricing: '有料 $1/月〜' }, rss: { role: 'Web → RSS', pricing: '有料 $1/月〜' }, mail: { role: 'Email → Webhook', pricing: '有料 $1/月〜' }, shot: { role: 'Screenshot / PDF', pricing: '有料 $1/月〜' }, fetch: { role: 'URL → Markdown / Metadata', pricing: '有料 $1/月〜' }, qr: { role: 'Dynamic QR / Redirect', pricing: '有料 $1/月〜' }, cron: { role: 'Cron実行 / 監視', pricing: '有料 $1/月〜' }, functions: { role: '小型serverless functions', pricing: '有料 $1/月〜' }, json: { role: 'JSON API / tiny DB', pricing: '有料 $1/月〜' }, files: { role: 'R2ファイル配信', pricing: '有料 $1/月〜' }, license: { role: 'ライセンスキー検証', pricing: '有料 $1/月〜' }, flags: { role: 'Remote Config', pricing: '有料 $1/月〜' }, monitor: { role: 'Webページ変更監視', pricing: '有料 $1/月〜' }, forms: { role: 'フォームbackend', pricing: '有料 $1/月〜' }
  }
};
...
const ZH: Messages = {
  ...
  products: {
    mcp: { role: 'MCP 托管 / Remote 转换', pricing: '付费 $1/月起' }, mock: { role: 'Mock API', pricing: '付费 $1/月起' }, hooks: { role: 'Webhook 收件箱 / replay', pricing: '付费 $1/月起' }, rss: { role: '网页 → RSS', pricing: '付费 $1/月起' }, mail: { role: 'Email → Webhook', pricing: '付费 $1/月起' }, shot: { role: '截图 / PDF', pricing: '付费 $1/月起' }, fetch: { role: 'URL → Markdown / Metadata', pricing: '付费 $1/月起' }, qr: { role: '动态 QR / Redirect', pricing: '付费 $1/月起' }, cron: { role: 'Cron 执行 / 监控', pricing: '付费 $1/月起' }, functions: { role: '轻量 serverless functions', pricing: '付费 $1/月起' }, json: { role: 'JSON API / tiny DB', pricing: '付费 $1/月起' }, files: { role: 'R2 文件分发', pricing: '付费 $1/月起' }, license: { role: '许可证密钥验证', pricing: '付费 $1/月起' }, flags: { role: 'Remote Config', pricing: '付费 $1/月起' }, monitor: { role: '网页变化监控', pricing: '付费 $1/月起' }, forms: { role: '表单 backend', pricing: '付费 $1/月起' }
  }
};
