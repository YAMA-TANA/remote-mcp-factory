...
const MESSAGES: Record<Locale, Messages> = { en: EN, ja: JA, 'zh-CN': ZH };

const LocaleContext = createContext<{ locale: Locale; setLocale: (locale: Locale) => void; messages: Messages } | null>(null);
...
export function LocaleProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(() => ({ locale, setLocale: setLocaleState, messages: MESSAGES[locale] }), [locale]);
