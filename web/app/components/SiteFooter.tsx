...
const COPY = {
  en: { tagline: 'Small developer services. One account, only the tools you need.', products: 'Explore', support: 'Information', pricing: 'Pricing', built: 'Developer tools, thoughtfully sized.' },
  ja: { tagline: '必要な開発者サービスを、ひとつのアカウントで。', products: 'サービス', support: 'ご案内', pricing: '料金', built: '必要な分だけ使える開発者ツール。' },
  'zh-CN': { tagline: '一个账号，按需使用开发者服务。', products: '浏览服务', support: '更多信息', pricing: '价格', built: '按需使用的开发者工具。' },
} as const;
