...
const COPY = {
  en: { kicker: 'CHECKOUT', title: 'Subscribe with Clerk Billing', body: 'Plans configured in Clerk appear here and open Clerk’s checkout drawer. PicoSvc recognizes picosvc_<service>_pico, picosvc_<service>_picoplus, picosvc_bundle_pico, and picosvc_bundle_pro plan keys.', user: 'Personal plans', org: 'Organization plans', missing: 'Clerk Billing is not configured for this build.' },
  ja: { kicker: 'CHECKOUT', title: 'Clerk Billingで契約', body: 'Clerkに作成したプランがここに表示され、公式checkout drawerで購入できます。PicoSvcは picosvc_<service>_pico / _picoplus と picosvc_bundle_pico / _pro のplan keyを自動認識します。', user: '個人向けプラン', org: 'Organization向けプラン', missing: 'このbuildではClerk Billingが設定されていません。' },
  'zh-CN': { kicker: 'CHECKOUT', title: '使用 Clerk Billing 订阅', body: '在 Clerk 中配置的套餐会显示在这里，并通过官方 checkout drawer 完成购买。PicoSvc 会自动识别 picosvc_<service>_pico / _picoplus 以及 picosvc_bundle_pico / _pro plan key。', user: '个人套餐', org: '组织套餐', missing: '此构建尚未配置 Clerk Billing。' },
} as const;
